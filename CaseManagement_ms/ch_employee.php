...
function getchoice($employee_id){
	...
	$objResponse->assign("Handler","value",$employee_id);
	$objResponse->assign("Handler_name","value",$employee_name);
...
<script>
	...
	$(document).ready(function() {
		$('#choice_table').dataTable( {
			...
			"ordering": false,
			"ajaxSource": '/smarty/templates/$site_db/$templates/sub_modal/base/team_ms/server_employee.php?site_db=$site_db',
			"language": {
						"sUrl": "$dataTable_de"
					},
